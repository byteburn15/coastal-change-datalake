...
if img1_file and img2_file:
    ...
    # Resize to 800x800 for uniformity
    ...
    with col1:
        st.image(img1, caption="Earlier Image", use_container_width=True)
    with col2:
        st.image(img2, caption="Recent Image", use_container_width=True)
    with col3:
        st.image(highlight, caption="Detected Changes (Red Areas)", use_container_width=True)
